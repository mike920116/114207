...
from services.social import social_bp      # ✅ 加這行
from services.announcement import announcement_bp
from services.admin.admin_announcement import admin_announcement_bp
# ─────────────────────────────────────────
...
app.register_blueprint(social_bp,       url_prefix="/social")  # ✅ 註冊路由
