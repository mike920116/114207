            ...
            <div class="insight-bubble">
                ...
                <div class="recommendation-analysis">
                    <div class="reco-tags-container">
                        <div class="reco-item" data-id="guide_start" title="了解情緒AI的基本功能和使用方法">
                            ...
                            <button class="add-to-favorites" onclick="addToFavorites('guide_start', 'guide', '開始使用導覽', '了解情緒AI的基本功能和使用方法')" title="加入收藏">
...
function updateInsightPanel(sidebarReco) {
    if (!sidebarReco) {
        console.warn('⚠️ 側邊欄推薦數據為空');
        return;
    }
    
    // 使用新的addInsightMessage函數來添加訊息
    addInsightMessage(
        sidebarReco.summary,
        '🧠',
        '洞察AI助手',
